...
<head>
    ...
    <meta name="description" content="<?php $_settings->info('name') ?>"/>
    <meta name="google-site-verification" content="aTC_uTkflYW1rEvVjWb4L3JRuID5AvkzGYJzV1p7SSo" />
  ...
  <link rel="stylesheet" href="<?php echo base_url ?>plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    ...
    #main-header:before{
        ...
        width:100%;
        height:100%;
        background-image:url(<?php echo base_url.$_settings->info('no_verse') ?>);
