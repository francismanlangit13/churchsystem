                    ...
                    ?>
                        <a class="list-group-item list-group-item-action my-2 border bg-gradient blog-item" href="<?php echo base_url.$row['blog_url'] ?>">
                            ...
                            <div class="w 100 d-flex justify-content-end">
                                <span class="text-muted" style="font-size: 0.8rem; margin-top:2rem;">Published: <?php echo date("M d, Y h:i A", strtotime($row['date_created'])) ?> By</span><br>
                                <span class="text-muted" style="font-size: 0.8rem; margin-top:2rem;">: <i><?php echo ucwords($row['author']) ?></i></span>
                            </div>
                        </a>
                <?php endwhile; ?>
                </div>
