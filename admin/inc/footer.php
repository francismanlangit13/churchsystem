...
<footer class="main-footer text-sm">
  <div class="container">
    ...
    <div class="float-right d-none d-sm-inline-block">
      <b>Developer <a href="https://franzcarl.ueuo.com" target="_blank" rel="noopener">franzcarl13</a></b> V<?php echo $_settings->info('system_version') ?>
    </div>
  </div>
</footer>
    </div>
    ...
    <?php if ($_settings->info('enable_teleg') == 1){ ?>
    <!--Start of Telegram Script-->
    <script> 
        window.intergramId = "<?php echo $_settings->info('TelegmsgAPI') ?>";
        ...
        introMessage: 'Anything I can help?',
            ...
            autoNoResponse: 'Sorry, ' +
                            'The admin is offline. please chat later.',
