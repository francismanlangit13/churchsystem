				...
				<div class="row">
					...
					<div class="form-group col-md-2">
						...
						<select type="text" id="status" onchange="showDiv(this)" name="status" class="form-control form-control-sm form-control-border select2" required>
							<option value="" selected disabled>Membership Approval</option>
...
<script>
	...
	$('#manage-user').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp ==1){
					location.href = './?page=verify_membership';
				}else{
	...
	$(function(){
        $('.sched-item').click(function(){
            ...
            uni_modal_small("Profile for <i>"+name+" "+name1+"</i>","verify_membership/view_img.php?id="+id,"mid-large")
        })
    })
