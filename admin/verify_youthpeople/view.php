				...
				<div class="row">
					...
					<div class="form-group col-md-2">
						...
						<select type="text" id="status" onchange="showDiv(this)" name="status" class="form-control form-control-sm form-control-border select2" required>
							<option value="" selected disabled>YP Approval</option>
...
<script>
	...
	$('#manage-user').submit(function(e){
		...
		start_loader()
		$.ajax({
			url:_base_url_+'classes/Users.php?f=savev',
			...
			success:function(resp){
				if(resp ==1){
					location.href = './?page=verify_youthpeople';
				}else{
	...
	$(function(){
        $('.sched-item').click(function(){
            ...
            uni_modal_small("Profile for <i>"+name+" "+name1+"</i>","verify_youthpeople/view_img.php?id="+id,"mid-large")
        })
    })
