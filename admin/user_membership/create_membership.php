			...
			<form action="" id="manage-user">
				<div class="row">
					...
					<div class="form-group col-md-12">
						...
						<input type="text" name="Ask_q1" id="Ask_q1" class="form-control" autocomplete="off" required>
					</div>
					<div class="form-group col-md-12">
						<label for="Ask_q2" class="required-field">Question 2: How did you find our church recommended or by accident?</label>
						<input type="text" name="Ask_q2" id="Ask_q2" class="form-control" autocomplete="off" required>
					</div>
					<div class="form-group col-md-12">
						...
						<input type="text" name="Ask_q3" id="Ask_q3" class="form-control" autocomplete="off" required>
					...
					<div class="form-group col-md-12">
						...
						<input type="text" name="Ask_q4" id="Ask_q4" class="form-control" autocomplete="off" required>
						<small><b>Example:</b> Juan Dela Cruz</small><br>
						<small><b>Example:</b> yourusername</small><br>
	...
	$('#manage-user').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					setTimeout("location.href = './?page=user_membership';",1500);
				} else if(resp == 2){
